...
@section('content')
<div id="fh5co-title-box" style="background-image: url('{{ asset('24-news/images/camila-cordeiro-114636.jpg') }}'); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
    <div class="overlay" style="pointer-events: none;"></div>
    <div class="page-title">
        <img src="{{ asset('24-news/images/person_1.jpg') }}" alt="Free HTML5 by FreeHTMl5.co">
